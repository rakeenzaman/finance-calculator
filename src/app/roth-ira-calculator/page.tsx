...
export default function Home() {
  ...
  const endBalance = startingBalanceFutureValue + contributionFutureValue;
  const totalContributions = startingBalanceValue + yearlyContributionValue * yearCount;
  const interestEarned = endBalance - totalContributions;
  ...
  return (
    <main className="ira-calc-page">
      <section className="ira-calc-card">
        <h1 className="ira-calc-title">Roth IRA Calculator</h1>
        <h2 className="ira-calc-subtitle">
          Estimate your future Roth IRA value using starting balance, yearly contributions, years, and annual return.
        </h2>
